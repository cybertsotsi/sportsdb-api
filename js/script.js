...
const loadPlayers = () =>{
    ...
    const url = `https://www.thesportsdb.com/api/v1/json/123/searchplayers.php?p=${searchText}`;
    fetch(url)
    .then(res => res.json())
...
const playerDetails = playerID =>{
    const url = `https://www.thesportsdb.com/api/v1/json/123/lookupplayer.php?id=${playerID}`;
    fetch(url)
    .then(res => res.json())
